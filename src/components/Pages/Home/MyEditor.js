...
async function sendMail(senderId, reciverId, sentData, reciveData, setSending) {
    setSending(true);
    try {
        const responseToSender = await fetch(`https://mail-box-client-65adf-default-rtdb.firebaseio.com/mailbox/users/${senderId}/sentmails.json`, {
            method: 'POST',
            headers: {
        ...
        await fetch(`https://mail-box-client-65adf-default-rtdb.firebaseio.com/mailbox/users/${reciverId}/recivedmails.json`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
