...
async function getMessage(email , id){
    ...
    try {
     const unreadRes =  await fetch(`https://new-one-6f2ca-default-rtdb.firebaseio.com/newuser/%20%20%20%20%20%20users/${emailID}/recivedmails/${id}.json`,{
          method:'PATCH',
          headers:{
      ...
      const response =  await fetch(`https://new-one-6f2ca-default-rtdb.firebaseio.com/newuser/%20%20%20%20%20%20users/${emailID}/recivedmails/${id}.json`)
